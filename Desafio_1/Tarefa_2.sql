...
CREATE TABLE TB_DETAILINES (
	DETAILLINE_ID BIGINT PRIMARY KEY,
...
CREATE TABLE TB_MENUITEM (
	MENUITEM_ID BIGINT PRIMARY KEY,
	MINUM INT NOT NULL,
...
CREATE TABLE TB_TYPE_DISCOUNT (
	TYPE_DISCOUNT_ID SMALLINT PRIMARY KEY,
	REASON VARCHAR(255),
	DISCOUNT_ID_FK BIGINT NOT NULL,
...
CREATE TABLE TB_SERVICECHARGE (
	SERVICECHARGE_ID BIGINT PRIMARY KEY,
...
CREATE TABLE TB_TENDERMEDIA (
	TENDERMEDIA_ID BIGINT PRIMARY KEY,
	VALUE DECIMAL(10,2),
	GUESTCHECKLINEITEM_ID_FK BIGINT,
	FOREIGN KEY (GUESTCHECKLINEITEM_ID_FK) REFERENCES TB_DETAILINES(DETAILLINE_ID)
);
...
CREATE TABLE TB_TYPE_TENDERMEDIA (
	TYPE_TENDERMEDIA_ID SMALLINT PRIMARY KEY,
	PAYMENT_TYPE VARCHAR(255),
	TENDERMEDIA_ID_FK BIGINT NOT NULL,
...
CREATE TABLE TB_ERRORCODE (
	ERRORCODE_ID SMALLINT PRIMARY KEY,
	INFORMATIVE VARCHAR(255),
	GUESTCHECKLINEITEM_ID_FK BIGINT UNIQUE,
	FOREIGN KEY (GUESTCHECKLINEITEM_ID_FK) REFERENCES TB_DETAILINES(DETAILLINE_ID)
);
...
CREATE TABLE TB_TYPE_ERRORCODE (
	...
	ERRORCODE_ID_FK SMALLINT NOT NULL,
	MESSAGE VARCHAR(255),
